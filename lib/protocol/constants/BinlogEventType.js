const BinlogEvents = {
  ...
  // Additional Events
  ROWS_EVENT: 0x24,
  WRITE_ROWS_EVENT: 0x25,
  UPDATE_ROWS_EVENT: 0x26,
  DELETE_ROWS_EVENT: 0x27,

};

BinlogEvents.eventName = function(type)
{
  return Object.keys(this).find(k => this[k] === type);
};

module.exports = BinlogEvents;
