...
{ 
  ...
  constructor(conf)
  {
    ...
    this.on('newListener', function(event, listener)
    {
      ...
      // if (BinlogEvent.hasOwnProperty(event)) this._binlogNativeEvents = true;
  ...
  _disconnect(cb)
  {
    ...
    {
      // we are resetting everything; so nothing to be done here
    }
    finally
    {
      ...
      var t = setTimeout(function()
        {
          ...
          {
            if (err) return this.emit(Event.ERROR_RECOVER, err);
